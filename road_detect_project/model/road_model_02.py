...
class Evaluator(object):
    ...
    def build(self):
        ...
        self.model.build(self._x, self._keep_prob)
        self.output = self.model.output

        self.cost = self.model.get_cost(self._y, self._mix_factor)  # + self.model.getL2() * self.params.l2_reg
...
if __name__ == '__main__':
    ...
    init_model = r"./road_model/model_8/model.ckpt"
    evaluator = Evaluator(model=model, dataset=None,op_params=optimization_params, init_model=init_model)
    evaluator.build()
    # evaluator.fit(10, 16)
