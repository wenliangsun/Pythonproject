...
from road_detect_project.model.params import DatasetParams
...
test_data = dataset.data_set['test']
print("test")
...
cross_entropy = -tf.reduce_sum(y_ * tf.log(y_out + 1e-10) + (1 - y_) * tf.log(1 - y_out + 1e-10)) / 256
...
with tf.Session() as sess:
    ...
    for i in range(1000):
        ...
        if i % 3 == 0:
            ...
            saver.save(sess, r'./model_test_01/model.ckpt')
